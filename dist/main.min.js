...
/***/ function(module, exports, __webpack_require__) {
	...
	var _expireStamp = __webpack_require__(44);

	var _expireStamp2 = _interopRequireDefault(_expireStamp);

	var _webStorage = __webpack_require__(46);

	var _indexedDB = __webpack_require__(45);
	...
	var Model = function () {
	    function Model() {
	        ...
	        if (Model.base) {
	            ...
	            Model.DB = new _indexedDB2.default(this.base.match(/^(\w+:\/\/)?([^\/]+)/i)[2]);
	        } else {
	         ...
	         */
	        _superagent2.default.Request.prototype.cache = function (timeString) {
	            ...
	            if (!this._expire) {
	                ...
	                var isSession = void 0;
	                var rules = timeString.split(',').map(function (rule) {
	                ...
	                this._expire = { session: isSession, stamp: (0, _expireStamp2.default)(rules) };
	            }
	        ...
	        _superagent2.default.Request.prototype.end = function () {

	            // console.info('end method, called at ', Date.now());
	            // console.log(this);
	            var self = this;
	            var userHandler = arguments[0];
	            var i = 0,
	                len = void 0,
	                result = void 0;
	            var cacheUsed = this._expire && this.method == 'GET';
	            var cache = null,
	                now = Date.now();
	            ...
	            if (Model.DB && cacheUsed && !self._expire.session) {
	                ...
	                (_Model$DB = Model.DB).get.apply(_Model$DB, (0, _toConsumableArray3.default)(self._expire.key.split('__by__'))).then(function (cache) {
	                    // 2.3 if db failed, get cache from localStorage with KEY
	                    cache = cache || _webStorage.LocalStorage.get(self._expire.key);
	                        ...
	                        return oldEnd.call(self, function (err, res) {
	                            ...
	                            if (/null/i.test(Object.prototype.toString.call(err))) {
	                                (function () {
	                                    ...
	                                    var _split = (self._expire.key + '').split('__by__');
	                                    ...
	                                    Model.DB.set(store, key, cache).catch(function () {
	                                        _webStorage.LocalStorage.set(self._expire.key, cache);
	                                    });
	                                })();
	                            }
	                ...
	                try {
	                    ...
	                    if (self._expire.session) {
	                        ...
	                        cache = _webStorage.SessionStorage.get(self._expire.key);
	                    } else {
	                        // 2.3 if db failed, get cache from localStorage with KEY
	                        cache = cache || _webStorage.LocalStorage.get(self._expire.key);
	                    }
	                    ...
	                    return oldEnd.call(self, function (err, res) {
	                        ...
	                        if (cacheUsed && /null/i.test(Object.prototype.toString.call(err))) {
	                            ...
	                            if (self._expire.session) {
	                                _webStorage.SessionStorage.set(self._expire.key, _cache);
	                            } else {
	                                _webStorage.LocalStorage.set(self._expire.key, _cache);
	                            }
	                        }
	    ...
	    (0, _createClass3.default)(Model, null, [{
	        key: '_formKey',
	        value: function _formKey(url, query) {

	            url = url.replace(Model.base, '').replace(/^\/|\/$/, '').replace(/\//, '.');

	            var queryStr = query.reduce(function (qStr, pair) {
	                pair = pair.replace('=', '.');
	        ...
	        value: function use(_ref) {
	            var base = _ref.base;
	            var _ref$beforeIntercepto = _ref.beforeInterceptors;
	            var beforeInterceptors = _ref$beforeIntercepto === undefined ? [] : _ref$beforeIntercepto;
	            var _ref$afterInterceptor = _ref.afterInterceptors;
	            var afterInterceptors = _ref$afterInterceptor === undefined ? [] : _ref$afterInterceptor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = getExpireStamp;
	...
	function _timeParser(str) {
	    ...
	    var _str$match = str.match(/(\d+)\s*([A-Za-z]+)\s*(\d+)?/);

	    var _str$match2 = (0, _slicedToArray3.default)(_str$match, 4);

	    var count = _str$match2[1];
	    var type = _str$match2[2];
	    var date = _str$match2[3];
	 ...
	 * @private
	 */
	function _parseDate(year, month) {
	    var date = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;


	    var stamp = Date.parse(year + ', ' + month + ', ' + date);

	    if ((0, _isNan2.default)(stamp)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexedDB = function () {
	    ...
	    (0, _createClass3.default)(IndexedDB, [{
	        key: 'get',
	        ...
	        value: function get(store, key) {
	            return new _promise2.default(function (resolve, reject) {
	                ...
	                if (IndexedDB.db) {
	                    ...
	                    IndexedDB.open().then(function (ok) {
	        ...
	        key: 'set',
	        value: function set(store, key, val) {
	            return new _promise2.default(function (resolve, reject) {
	                ...
	                if (!IndexedDB.db) {
	                    ...
	                    IndexedDB.open(store).then(function (ok) {
	                        try {
	        ...
	        value: function open(store) {
	            return new _promise2.default(function (resolve, reject) {
	                ...
	                var request = IndexedDB.DB.open(IndexedDB.baseName, parseInt(Date.now() / 100));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LocalStorage = exports.SessionStorage = undefined;
	    ...
	    function Storage(type) {
	        ...
	        this.set = function (key, value) {
	            ...
	            if (Storage.storageAvailable(type)) {
	                var _key = (0, _stringify2.default)(key);
	                var _value = (0, _stringify2.default)(value);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var requestBase = __webpack_require__(95);
